...
def test_hello_schema_distinction_udf(holder):
    ...
    insert1 = h.queries[3]
    assert to_sql([insert1.statement_substituted]) == ["INSERT INTO target (age) SELECT (SELECT 'no_schema') AS age"]

    insert2 = h.queries[4]
    assert to_sql([insert2.statement_substituted]) == ["INSERT INTO target (age) SELECT (SELECT 'yes_schema') AS age"]
...
def test_hello_default_params_udf(holder):
    ...
    actual_after = [insert_query_2.statement_substituted]
...
def test_hello_inout_parameter_udf(holder):
    ...
    actual_after_1 = [insert_query_1.statement_substituted]
...
def test_hello_table_parameter_udf(holder):
    ...
    actual_after_2 = [insert_query_2.statement_substituted]
    assert to_sql(actual_after_2) == insert_after

    insert_query_alias = h.queries[5]
    actual_after_alias = [insert_query_alias.statement_substituted]
...
def test_hello_row_parameter_udf(holder):
    ...
    actual_after_from = [insert_query_from.statement_substituted]
...
def test_mleast_variadic_parameter_udf(holder):
    ...
    actual_after_3 = [insert_query_3.statement_substituted]
    ...
    actual_after_4 = [insert_query_4.statement_substituted]
...
def test_hello_overloading_udf(holder):
    ...
    actual_after_5 = [insert_query_5.statement_substituted]
